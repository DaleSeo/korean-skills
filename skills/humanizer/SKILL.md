...
- 우선순위에 따라 구성된 6개 카테고리의 36가지 고유 패턴을 분석하며, 각 패턴은 S1/S2/S3 심각도로 분류됩니다
...
2. **텍스트 분석** - 아래에 설명된 36가지 검출 패턴에 대해 분석
...
전체 36가지 패턴 목록과 상세 내용은 각 카테고리 참조 문서 참조.
