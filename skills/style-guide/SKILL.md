---
name: style-guide
description: Korean document style consistency checker. Detects inconsistencies in tone (formal vs informal speech), terminology (user vs yuja), numbering formats, list styles, quotation marks, and datetime formats. Ensures uniform writing style across documents. Use when reviewing multi-author documents, maintaining project-wide terminology standards, preparing formal documents, or enforcing brand voice guidelines in Korean text.
license: MIT
metadata:
  author: DaleSeo
  version: "1.0.0"
